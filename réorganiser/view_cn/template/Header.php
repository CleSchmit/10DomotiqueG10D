...
<body>
    ...
    <div id="menu">
        ...
        <ul>
            <li><a href="index.php?action=Accueil"><br>欢迎</a></li>
            <li><a href="index.php?action=L'Entreprise"><br>简介</a>
            <li><a href="index.php?action=NosProduits"><br>我们的产品</a></li>
            <li><a href="index.php?action=forum"><br>疑难解答</a></li>
            <li><a href="index.php?action=Contacter"><br>与我们联系</a></li>
